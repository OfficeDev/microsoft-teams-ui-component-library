...
module.exports = function cli(args) {
  ...
  fs.writeFileSync(`${args[3]}/react-teams-theme.js`, `// === === === === === ===
// DON’T EDIT THIS FILE DIRECTLY.
// This file is generated by the fluentui-react-teams-theme cli from @fluentui/react-teams.
// === === === === === ===

module.exports = ${
      JSON.stringify(colors(config), null, 2)
    }`
  )
